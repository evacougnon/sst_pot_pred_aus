...
#fname = '../../ana/PotPred/vSZ/SSA/All_SSA_RCs_daily_NoWeight.nc'
fname = '../../ana/PotPred/vSZ/SSA/All_SSA_RCs_daily_NoWeight_365.nc'
...
print('nino34, p val: '+ repr(p_nino34) +'')
...
print('Ningaloo Nino, p val: '+ repr(p_ning) +'')
