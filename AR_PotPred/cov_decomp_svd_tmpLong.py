...
outfile_mtx = '/v_Munk_Drive/ecougnon/ana/PotPred/PotPred_CovMtx_Aus_daily_1deg'
outfile = '/v_Munk_Drive/ecougnon/ana/PotPred/EOF/cov_decomp_1yr_ZFL_SVD_Aus_daily_1deg_Modes1-8'
...
lon_flat = np.repeat(np.copy(lon),len(lat))
